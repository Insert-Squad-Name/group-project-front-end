...
/***/ function(module, exports, __webpack_require__) {
	...
	var myApp = __webpack_require__(4);

	var userActions = __webpack_require__(5);
	var entryActions = __webpack_require__(7);
	var pageActions = __webpack_require__(8);
	var pageSwitch = __webpack_require__(6);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var signUp = function signUp(e, signIn, populatePages) {
	  e.preventDefault();
	...
	var signIn = function signIn(e, populatePages) {
	  e.preventDefault();
	  var formData = new FormData(e.target);
	  $.ajax({
	...
	var updateUsernameLabel = function updateUsernameLabel() {
	  if (!myApp.user) {
	    $(".username").text("");
	  } else {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var page1Handler = function page1Handler() {
	  $('#page1').show();
	  $('#page2').hide();
	};

	var page2Handler = function page2Handler() {
	  $('#page2').show();
	  $('#page1').hide();
	};

	var page3Handler = function page3Handler() {
	  $('#page3').show();
	  $('#page2').hide();
	  $('#text-editor').hide();
	};

	var page2from3 = function page2from3() {
	  $('#page2').show();
	  $('#page3').hide();
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	//FIXME Violates our separation of concerns/dependency model. Should use a call back in index.js instead of requiring page-actions here.
	...
	//DELETE ENTRIES
	var deleteEntry = function deleteEntry(event, showPage) {
	...
	var clearActiveEditor = function clearActiveEditor() {
	...
	var getUpdateId = function getUpdateId(event) {
	  event.preventDefault();
	  var id = $(event.target).attr("data-update-page");
	  populateEditorWithContent(id);
	  $(".patching-button").attr("data-update-page", id);
	};

	var patchOrCreate = function patchOrCreate(e) {
	  e.preventDefault();
	...
	var populateEditorWithContent = function populateEditorWithContent(entryId) {
	  var entry = void 0;
	  //FIXME pages.pages???
	  myApp.page.pages._entries.forEach(function (cV) {
	    if (cV._id === entryId) {
	      entry = cV;
	    }
	  });
	  tinyMCE.activeEditor.setContent(entry.body);
	};

	module.exports = {
	  createEntry: createEntry,
	  deleteEntry: deleteEntry,
	  clearActiveEditor: clearActiveEditor,
	  // showEntries
	  updateEntry: updateEntry,
	  getUpdateId: getUpdateId,
	  patchOrCreate: patchOrCreate
	};
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(2)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	var displayPages = function displayPages(response) {
	  var pages = formatEntries(response.pages);
	  console.log(response.pages);
	  var pagesTemplate = __webpack_require__(9);
	  $('.pages-collection').html(pagesTemplate({ pages: pages }));
	};
	...
	var pageUserIndex = function pageUserIndex() {
	  $.ajax({
	...
	var pageCreate = function pageCreate(e) {
	  e.preventDefault();
	  // console.log(e);
	  var formData = new FormData(e.target);
	  $.ajax({
	...
	var displayEntries = function displayEntries(response) {
	  var entries = formatEntries(response.pages._entries);
	  var entryListing = __webpack_require__(29);
	  $('.display-entries').empty();
	...
	/* HELPER FUNCTIONS */
	var formatEntries = function formatEntries(entries) {
	  entries.reverse();
	  entries.forEach(function (cV, i, a) {
	    var ISOdate = new Date(cV.createdAt);
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"col-xs-6 col-lg-4 user-pages\" >\n    <button type=\"button\" class=\"close close-page-button\" data-dismiss=\"alert\" aria-label=\"Close\" data-delete-page=\""
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\"><span data-delete-page=\""
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<div class=\"col-xs-6 col-lg-4 page-entries\" >\n    <button type=\"button\" class=\"close close-entry-button\" data-dismiss=\"alert\" aria-label=\"Close\" entry-id=\""
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\"><span entry-id=\""
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    ...
	    + "\n    </div>\n    <button type=\"button\" class=\"update-button\" data-target=\"#text-editor-modal\" data-toggle=\"modal\" href=\"#\" role=\"button\" data-update-page=\""
	    + alias4(((helper = (helper = helpers._id || (depth0 != null ? depth0._id : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"_id","hash":{},"data":data}) : helper)))
	    + "\">Update Blog!</button>\n</div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data) {
	    var stack1;
